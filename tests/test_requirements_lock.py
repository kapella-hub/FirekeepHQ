...
# docdex/, maildex/ and hands/ are WHEELS installed into a user's virtualenv: pinning a
...
def test_only_image_services_are_locked() -> None:
    """client/, symdex/, docdex/, maildex/ and hands/ ship as WHEELS and must NOT be locked.
    ...
    """
    for pkg in ("client", "symdex", "docdex", "maildex", "hands"):
