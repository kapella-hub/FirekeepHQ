...
| FirekeepSentinel | `sentinel/` | 8060 | Environment observer (collectors + webhook intake) |
...
**Config:** `AUTH_ENABLED=false`, `AUTH_REDIS_URL=redis://redis:6379/7`, `FIREKEEP_INTERNAL_KEY`, `DASHBOARD_API_KEY`
