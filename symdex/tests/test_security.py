...
from firekeep_symdex.security import (
    validate_path,
    is_symlink_escape,
    is_secret_file,
    is_binary_extension,
...
class TestDiscoverLocalFilesSecure:
    def test_excludes_secret_files(self, tmp_path):
        ...
        from firekeep_symdex.tools.index_folder import discover_local_files
...
class TestIndexRepoSecretFilter:
    def test_secret_files_filtered_in_discovery(self):
        ...
        from firekeep_symdex.tools.index_repo import discover_source_files
